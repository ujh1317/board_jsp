		...
		<div class="row">
			<form method="post" action="writeAction.jsp">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control" name="boardTitle" placeholder="제목" maxlength="50"></td>
						</tr>
						<tr>	
							<td><textarea class="form-control" name="boardContent" placeholder="내용" maxlength="2048" style="height: 350px;"></textarea></td>
						</tr>
					</tbody>
				</table>
